...
Original file is located at
    https://colab.research.google.com/drive/1CTWgF7OQE1Gk7JlRAbsyzXbSOEc3fxPF
"""
...
def test_qlsh_dataset(name=None, dataset_type='iris'):
    ...
    if name is not None:
        ...
        elif dataset_type == "fetch_covtype":
            from sklearn.datasets import fetch_covtype
            dataset  = fetch_covtype()
            dataset_name="fetch_covtype"
        else:
            print(f"Unknown dataset type: {dataset_type}")
            print("Available types: iris, breast_cancer, wine, digits,Housing")
            return False
